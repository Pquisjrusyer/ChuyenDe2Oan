...
export async function renderRegister(container) {
          ...
          <form class="reg-form-right-col trailer-scroll-reveal trailer-reveal-fade-up delay-150" id="regAccountForm" data-node-id="1283:79146" onsubmit="return false;">
            ...
            <div class="reg-field-group" data-node-id="1283:79185">
              ...
              <div class="reg-field-input-box">
                ...
                <button type="button" class="reg-password-toggle-btn" data-target="regPassword" aria-label="Hiện/Ẩn mật khẩu">
            ...
            <div class="reg-field-group" data-node-id="1283:79204">
              ...
              <div class="reg-field-input-box">
                ...
                <button type="button" class="reg-password-toggle-btn" data-target="regConfirmPassword" aria-label="Hiện/Ẩn mật khẩu">
                  <svg class="eye-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                    <circle cx="12" cy="12" r="3"></circle>
                  </svg>
  ...
  // 4. Password Show/Hide Toggle Controller
  const toggleBtns = container.querySelectorAll('.reg-password-toggle-btn');
