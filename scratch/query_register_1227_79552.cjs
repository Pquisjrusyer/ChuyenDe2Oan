...
post(initMsg, null, (err, res, sid) => {
  ...
  post(callMsg, sid, (err2, res2) => {
    ...
    fs.writeFileSync('f:/PROJECT-SOFTWARE/OanNe/scratch/register_1227_79552.txt', JSON.stringify(res2, null, 2));
    console.log('Saved design context for 1227:79552 to scratch/register_1227_79552.txt!');
  });
});
