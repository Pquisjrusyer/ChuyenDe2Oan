...
post(initMsg, null, (err, res, sid) => {
  ...
  post(callMsg, sid, (err2, res2) => {
    ...
    fs.writeFileSync('f:/PROJECT-SOFTWARE/OanNe/scratch/meta_1227_79552.json', JSON.stringify(res2, null, 2));
    console.log('Saved metadata for 1227:79552 to scratch/meta_1227_79552.json!');
  });
});
