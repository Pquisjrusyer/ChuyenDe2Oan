...
post(initMsg, null, (err, res, sid) => {
  ...
  post(callMsg, sid, (err2, res2) => {
    ...
    fs.writeFileSync('f:/PROJECT-SOFTWARE/OanNe/scratch/node_1195_78612.json', JSON.stringify(res2, null, 2));
    console.log('Saved design context for 1195:78612 to scratch/node_1195_78612.json!');
  });
});
