...
with open('scratch/node_1363_87501.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
with open('scratch/login_success_code.tsx', 'w', encoding='utf-8') as out:
    out.write(code)

print('Saved code to scratch/login_success_code.tsx!')
