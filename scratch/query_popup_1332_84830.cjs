...
post(initMsg, null, (err, res, sid) => {
  ...
  post(callMsg, sid, (err2, res2) => {
    ...
    fs.writeFileSync('f:/PROJECT-SOFTWARE/OanNe/scratch/popup_1332_84830.txt', JSON.stringify(res2, null, 2));
    console.log('Saved design context for 1332:84830 to scratch/popup_1332_84830.txt!');
  });
});
