...
post(initMsg, null, (err, res, sid) => {
  ...
  post(callMsg, sid, (err2, res2) => {
    ...
    fs.writeFileSync('f:/PROJECT-SOFTWARE/OanNe/scratch/node_1332_84911.json', JSON.stringify(res2, null, 2));
    console.log('Saved design context for 1332:84911 to scratch/node_1332_84911.json!');
  });
});
